...
export function GovernmentPortalsSection({ lang }: Props) {
  return (
    <section className="border-b border-[#f0ece5] bg-slate-50/30">
          ...
          {UAE_GOVERNMENT_PORTALS.map((portal) => (
            <li key={portal.id}>
              <a
                ...
                className="flex items-center justify-between rounded-xl border border-slate-200/80 bg-white px-4 py-3.5 text-sm text-slate-700 transition-colors hover:border-[#c9a86c]/40 hover:text-slate-900"
              >
