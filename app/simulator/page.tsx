...
const TEXT = {
  ...
  en: {
    ...
    breakdown: {
      ...
      governmentExtras: "Government / immigration procedures",
      ...
      bankAccount: "Bank account support",
      hinodeyaService: "Administrative fee (estimate)",
  ...
  ar: {
    ...
    breakdown: {
      ...
      governmentExtras: "إجراءات الحكومة / الهجرة",
      ...
      bankAccount: "دعم فتح الحساب البنكي",
      hinodeyaService: "رسوم إدارية (تقديرية)",
...
function buildMailto(
  ...
  const L: Record<Lang, Record<string, string>> = {
    ...
    en: {
      ...
      service: "Administrative fee (estimate)",
      visa: "Visa timeline",
      days: "business days",
